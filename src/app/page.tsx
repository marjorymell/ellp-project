      ...
      <div className="mb-8">
        ...
        {workshops.length === 0 && !error ? (
          <div className="text-center py-12">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Nenhuma oficina disponível no momento</h3>
            <p className="text-gray-600 mb-6">Fique atento! Novas oficinas serão divulgadas em breve.</p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <Link href="/setup-admin">
                  <Button variant="outline">Configurar Administrador</Button>
                </Link>
              </div>
            </div>
          </div>
